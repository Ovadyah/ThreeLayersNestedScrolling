...
/**
 * 通用 滑动嵌套处理布局，用于处理含有{@link RecyclerView}的嵌套套滑动
 * @author Ovadyah
 */
public class NestedScrollingBaseLayout extends LinearLayout implements NestedScrollingParent2 {


    public NestedScrollingParentHelper mNestedScrollingParentHelper = new NestedScrollingParentHelper(this);

    public NestedScrollingBaseLayout(Context context) {
        super(context);
    }

    public NestedScrollingBaseLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public NestedScrollingBaseLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
