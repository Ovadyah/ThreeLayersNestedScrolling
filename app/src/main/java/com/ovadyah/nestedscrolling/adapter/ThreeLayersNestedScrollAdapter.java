...
import com.ovadyah.nestedscrolling.ui.fragment.ThreeLayersNestedScrollItemFragment;
 ...
 * @author Ovadyah
 */
public class ThreeLayersNestedScrollAdapter extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {

    private final FragmentActivity mActivity;

    private String[] titles = {"嵌套Tab1", "嵌套Tab2", "嵌套Tab3"};

    private NestedScrollingOuterLayout mNestedScrollingOuterLayout;
    private int mSelectedPosition;


    public ThreeLayersNestedScrollAdapter(FragmentActivity activity) {
        mActivity = activity;
